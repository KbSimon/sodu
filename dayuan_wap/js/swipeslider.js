...
(function ($) {
  ...
  $.fn.swipeslider = function (options) {
    ...
    var slider = this.find('.sw-slides'); // reference to slider
     var swipslider = this.find('.sw-slides'); // reference to slider
    var defaultSettings = {
      /**
    ...
    */
    (function init() {
      // $(slideContainer).css('padding-bottom', settings.sliderHeight);
  ...
  //      .css('-webkit-transition-property', property)
    ...
    */
    function insertBullets(count) {
      swipslider.after('<ul class="sw-bullet"></ul>');
      var bulletList =swipslider.parent().find('.sw-bullet');
